...
;( function() {
    ...
    NodeDB.prototype = {
        ...
        createNode: function( nodeStructure, parentId, tree, stackParentId ) {
            ...
            //The previous line alters the ID:
            //TELDEEB: TODO:
            // Check MAX ID from nodeStructure
            // if Node has Id --> use it as is
            // else use ++MAX Id
    ...
    var JSONconfig = {
        ...
        getMaxID: function(nodeStructure) {
            // Ensure all nodes have id, otherwise return 0
            // Return max ID found
            this.all_have_id = true;
            //nodeStructure
        },
