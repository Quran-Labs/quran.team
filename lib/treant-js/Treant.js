    ...
    Tree.prototype = {
        ...
        positionNode: function(i, containerCenter, treeCenter, treeWidth, treeHeight, deltaX, deltaY, negOffsetX, negOffsetY){
            ...
            if (node.id !== 0 && !(node.parent().id === 0 && this.CONFIG.hideRootNode)) {
                // skip the root node
                if(!node.parent().positioned){
                    this.positionNode(node.parent().id, containerCenter, treeCenter, treeWidth, treeHeight, deltaX, deltaY, negOffsetX, negOffsetY);
                }
        ...
        positionNodes: function() {
            ...
            for ( i = 0, len = this.nodeDB.db.length; i < len; i++ ) {
               this.positionNode(i, containerCenter, treeCenter, treeWidth, treeHeight, deltaX, deltaY, negOffsetX, negOffsetY);
            }
            this.addUncles();
            return this;
        },
